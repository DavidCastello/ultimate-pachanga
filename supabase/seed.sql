...
with seed_scores (
  match_id, player_code, attack, defence, tactics, physical, attribute_codes
) as (
  values
  -- Jornada 1
  ('33333333-3333-4333-8333-000000000001', 'PLR-A7K2', 6, 9, 8, 7, '{zamora}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-B9F1', 2, 9, 7, 6, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-C3M8', 4, 8, 7, 8, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-D5P4', 5, 7, 6, 7, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-E8T6', 5, 6, 6, 8, '{injury}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-F2H9', 6, 8, 8, 7, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-G6J3', 8, 5, 8, 7, '{mvp}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-H4L7', 8, 4, 7, 8, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-J9N5', 7, 4, 6, 8, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-K1Q2', 9, 3, 7, 7, '{puskas}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-L7R8', 7, 3, 6, 6, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-M3S4', 6, 6, 6, 6, '{revelation}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-N8V6', 6, 7, 7, 6, '{}'),
  ('33333333-3333-4333-8333-000000000001', 'PLR-P5W9', 2, 8, 6, 6, '{}'),
  -- Jornada 2
  ('33333333-3333-4333-8333-000000000002', 'PLR-A7K2', 7, 8, 9, 7, '{mvp}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-B9F1', 3, 8, 7, 6, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-C3M8', 4, 9, 8, 8, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-D5P4', 5, 6, 6, 7, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-E8T6', 6, 7, 7, 7, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-F2H9', 6, 7, 8, 8, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-G6J3', 9, 5, 9, 7, '{puskas}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-H4L7', 7, 5, 7, 7, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-J9N5', 8, 4, 7, 8, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-K1Q2', 9, 4, 8, 8, '{mvp,puskas}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-L7R8', 6, 4, 6, 6, '{injury}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-M3S4', 7, 6, 7, 6, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-N8V6', 6, 6, 7, 7, '{}'),
  ('33333333-3333-4333-8333-000000000002', 'PLR-P5W9', 3, 9, 7, 6, '{zamora}')
),
resolved as (
  select
    ...
    round(
      (s.attack + s.defence + s.tactics + s.physical)::numeric / 4.0, 3
    ) as base_score,
...
inserted as (
  ...
  select
    match_id, player_id, metric_scores,
    base_score, attribute_points, base_score + attribute_points
  from resolved
